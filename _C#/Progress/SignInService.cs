...
namespace NeonKatana
{
    ...
    public class SignInService : MonoBehaviour
    {
        ...
        /// <summary>
        /// What to call this player until the server has a name they chose for themselves. See
        /// <see cref="ShortenToNameLength"/>; the id is the last resort, and the id is the address
        /// without its domain.
        /// </summary>
        ...
        void AcceptToken(string idToken, string newRefreshToken, int expiresInSeconds)
        {
            ...
            UserName = ShortenToNameLength(claims.name) ?? PlayerId;
